...
public class ActivityMenuPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonVerMisRutas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityMenuPrincipal.this,ActivityVerMisRutas.class);
        ...
        botonHistorialRutas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityMenuPrincipal.this,ActivityHistorialRutas.class);
                startActivity(intent);
